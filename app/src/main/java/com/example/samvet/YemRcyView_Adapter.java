...
public class YemRcyView_Adapter extends RecyclerView.Adapter<YemRcyView_Adapter.MyViewHolder> {
    private Context context;
    private ArrayList<YemModel> yemModels;
    private HashMap<String, Double> sabitler;
    private double toplamSonuc = 0.0;

    public YemRcyView_Adapter(Context context, ArrayList<YemModel> yemModels) {
                ...
                try {
                    if (s.toString().isEmpty()) {
                        ...
                        if (toplamSonuc<=2262){
                            ...
                            Toast.makeText(context, "Hata: Değer 2262 altında kalamaz", Toast.LENGTH_SHORT).show();
                        }
                    }
