...
public class YemRcyView_Adapter2 extends RecyclerView.Adapter<YemRcyView_Adapter2.MyViewHolder> {
    private Context context;
    private ArrayList<YemModel> yemModels;
    private HashMap<String, Double> sabitler;
    private double toplamSonuc = 0.0;

    public YemRcyView_Adapter2(Context context, ArrayList<YemModel> yemModels) {
                ...
                try {
                    if (s.toString().isEmpty()) {
                        ...
                        if (toplamSonuc<2262){
                            ...
                            Toast.makeText(context, "Hata: Değer 3184 aşamaz", Toast.LENGTH_SHORT).show();
                        }
                    }
